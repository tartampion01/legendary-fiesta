...
class IL_Utils
{
    ...
    public static function getJobGarage($succursale){
        ...
        $data = '<tr class="trHeader">
                    ...
                    <td class="jg compagnie" onclick="sort_table(5, this.parentNode.parentNode.parentNode.id);">Compagnie&nbsp;<img class="sortableArrows" src="../assets/images/sortable.png"></img></td>
                    <td class="jg heure">Heure</td>
                    <td class="jg date">Date</td>                    
                    <td class="jg transport" onclick="sort_table(8, this.parentNode.parentNode.parentNode.id);">Transport&nbsp;<img class="sortableArrows" src="../assets/images/sortable.png"></img></td>
                    <td class="jg indexStatut"></td>
                    <td class="jg statut" onclick="sort_table(9, this.parentNode.parentNode.parentNode.id);">Statut&nbsp;<img class="sortableArrows" src="../assets/images/sortable.png"></img></td>
                    <td class="jg datePrevue">Date prévue</td>
                    <td class="jg commentaire"onclick="sort_table(12, this.parentNode.parentNode.parentNode.id);">Commentaire&nbsp;<img class="sortableArrows" src="../assets/images/sortable.png"></img></td>
        ...
        $sql = "SELECT pkJobGarage, jobGarage, AV, fournisseur, vendeur, compagnie, heure, date, transport, statut, AMouPM, commentaire, datePrevue, archive FROM jobs_garage WHERE succursale='$succursale' AND archive=0";
        //echo $sql;
        $result = mysqli_query($conn, $sql);
        ...
        try
        {
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    $data .= "<td class='jg compagnie'><input type='text' id='tbCompagnie_" . $pkJobGarage . "' class='jg tbCompagnie' list='dlCompagnie' value='" . $row["compagnie"] . "'></input></td>";
    ...
    public static function getJobGarageArchive($succursale){
        ...
        $sql = "SELECT pkJobGarage, jobGarage, AV, fournisseur, vendeur, compagnie, heure, date, transport, statut, AMouPM, commentaire, datePrevue, archive FROM jobs_garage WHERE succursale='$succursale' AND archive=1";
        //echo $sql;
        $result = mysqli_query($conn, $sql);
        ...
        try
        {
            if(mysqli_num_rows($result) > 0){
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    $data .= "<td class='jg compagnie'><input readonly type='text' id='tbCompagnie_" . $pkJobGarage . "' class='jg tbCompagnie' list='dlCompagnie' value='" . $row["compagnie"] . "'></input></td>";
    ...
    public static function addJobGarage($jobGarage, $av, $vendeur, $fournisseur, $compagnie, $heure, $date, $transport, $statut, $datePrevue, $AMouPM, $commentaire, $succursale){
        ...
        $fournisseur = mysqli_real_escape_string($conn, $fournisseur);
        $compagnie = mysqli_real_escape_string($conn, $compagnie);
        $heure = mysqli_real_escape_string($conn, $heure);
        $date = mysqli_real_escape_string($conn, $date);
        ...
        $sql = "INSERT INTO jobs_garage(jobGarage,av,vendeur,fournisseur,compagnie,heure,date,transport,statut,datePrevue,AMouPM,commentaire,succursale) ";
        $sql .= "VALUES('$jobGarage','$av','$vendeur','$fournisseur','$compagnie','$heure','$date','$transport','$statut','$datePrevue','$AMouPM','$commentaire','$succursale')";
        mysqli_query($conn, $sql);
        $this->id = $conn->insert_id;
    ...
    public static function updateLigneJobGarage($pkJobGarage, $jobGarage, $av, $vendeur, $fournisseur, $compagnie, $heure, $date, $transport, $datePrevue, $AMouPM, $commentaire, $succursale)
    {
        $conn = IL_Database::getConn();
        ...
        $sql = "UPDATE jobs_garage SET jobGarage='$jobGarage', av='$av', vendeur='$vendeur', fournisseur='$fournisseur', compagnie='$compagnie', heure='$heure', date='$date', transport='$transport', datePrevue='$datePrevue', AMouPM='$AMouPM', commentaire='$commentaire', succursale='$succursale' WHERE pkJobGarage='$pkJobGarage'";
