...
<body onload="updateJobGarage();">
    ...
    <form id="frm" name="frm" action=""> 
        <table style="width:100%;">
            <tr>
                <td style="width:35%;text-align:left;"><img style="width: 388px; height: 81px;" src="../assets/images/LOGO_inter/logo_C5C5C5_<?php echo IL_Session::r(IL_SessionVariables::SUCCURSALE); ?>.png" alt=""/></td>            
