                ...
                <div name="row1" class="row clonable serializable">
                    <div class="col-xs-5">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <input type="text" name="tbNoFacture[]" id="2" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="3" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="4" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="5" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="6" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="7" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="8" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="9" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoFacture[]" id="10" value="" maxlength="20"  class="input"></input><br>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-5">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                ...
                                <input type="text" name="tbNoColis[]" id="2" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="3" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="4" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="5" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="6" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="7" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="8" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="9" value="" maxlength="20"  class="input"></input><br>
                                <input type="text" name="tbNoColis[]" id="10" value="" maxlength="20"  class="input"></input><br>
                            </div
                        </div>
                    </div>
                    <div class="col-xs-2 center">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <i name="moins" class="buttonStyle fa fa-minus"></i>
                                <i name="plus" class="buttonStyle fa fa-plus"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="awesomplete">
                            <input name="tbDestinataire" id="tbDestinataire" value="<?php echo $destinataire; ?>" maxlength="20" class="input " autocomplete="off" aria-autocomplete="list" type="text">
                            <ul hidden="">
                                <li aria-selected="false">De<mark>ry</mark></li>
                                <li aria-selected="false">Ger<mark>ry</mark></li>
                                <li aria-selected="false"><mark>Ry</mark>der</li>
                                <li aria-selected="false">Land<mark>ry</mark></li>
                                <li aria-selected="false">Fer<mark>ry</mark> dzinzio</li>
                                <li aria-selected="false">Fer<mark>ry</mark> dzindzio</li>
                                <li aria-selected="false">Ger<mark>ry</mark> dzindzio</li>
                                <li aria-selected="false"><mark>Ry</mark>der boucherville</li>
                            </ul>
            ...
            <section>
                ...
                <div class="row buttons">
                    <div class="col-xs-offset-1 col-xs-5 col-md-offset-1 col-md-5">
                        <!--<button name="btnSign" onclick="module_livraison.activerSignature()" data-action="doSignature"><i class="fa fa-pencil"></i>Faire signer le client</button>-->
                        <button name="btnSign" class="btnSign" data-action="doSignature" onclick="return false;"><i class="fa fa-pencil"></i>Faire signer le client</button>
                    </div>
                    <div class="col-xs-5 col-md-5">
                        <!--<button name="btnClear" onclick="module_signature.clearSignature('mod_signature')"><i class="fa fa-trash"></i>Effacer la signature</button>-->
                        <button name="btnClear" class="btnClear"><i class="fa fa-trash"></i>Effacer la signature</button>
                    </div>
                </div>
            </section>
            <section>
                <div class="row">
                    <div class="col-xs-offset-3 col-xs-6 col-md-offset-3 col-md-6">
                        <!--<button name="btnSave" onclick="module_livraison.sauvegarder()"><i class="fa fa-save"></i>Sauvegarder</button>-->
                        <button type="submit" name="btnSave" class="btnSave"><i class="fa fa-save"></i>Sauvegarder</button>
                    </div>
                </div>
            </section>
