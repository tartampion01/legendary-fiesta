...
<script type="text/javascript">
    ...
    function showBonCommandes() {
        ...
        xhttp.open("GET", "callBonCommande.php?succ=" + succ  + "&oper=readArchive");
        xhttp.send();
    }
    function deleteRow(pkBonCommande){
        ...
        var dataToAdd = "&oper=delFromArch&pk=" + pkBonCommande;
        xhttp.open("GET", "callBonCommande.php?succ=" + succ + dataToAdd, true);
        xhttp.send();
...
<body onload="updateBonCommandes();">
    ...
    <form id="frm" name="frm" action=""> 
        <table style="width:100%;background-color: #C5C5C5;">
            <tr>
                <td style="width:40%;text-align:left;"><img alt='Inter Anjou' style="width: 388px; height: 81px;" src="../assets/images/LOGO_inter/logo_C5C5C5_<?php echo IL_Session::r(IL_SessionVariables::SUCCURSALE); ?>.png" alt=""/></td>
