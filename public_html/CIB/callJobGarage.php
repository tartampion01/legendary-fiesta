...
else // On a un utilisateur connecté/authentifié
{
    ...
    switch ($operation)
    {
        ...
        case "readArchive":              echo IL_Utils::getJobGarageArchive($succursale);
                                         break;
        case "add":                      echo IL_Utils::addJobGarage($_GET["1"], $_GET["2"], $_GET["3"], $_GET["4"], $_GET["5"], $_GET["6"], $_GET["7"], $_GET["8"], $_GET["9"], $_GET["10"], $_GET["11"], $_GET["12"], $succursale);
                                         break;
        ...
        case "updateStatutReceptionnee": echo IL_Utils::updateStatutReceptionneeJobGarage($_GET["1"],$_GET["2"]);
                                         break;
                                         // updateLigne                      rowId       jobGarage   av          vendeur     fournisseur compagnie   heure       date        transport   datePrevue   AMouPM       commentaire;
        case "updateLigne":              echo IL_Utils::updateLigneJobGarage($_GET["1"], $_GET["2"], $_GET["3"], $_GET["4"], $_GET["5"], $_GET["6"], $_GET["7"], $_GET["8"], $_GET["9"], $_GET["10"], $_GET["11"], $_GET["12"], $succursale);
                                         break;
    }
}
?>